...
--added to find upgrade items
	if b.frame.UpgradeIcon then
		b.frame.UpgradeIcon:SetPoint("TOPLEFT", Qulight.bags.buttonsize/2.7, -Qulight.bags.buttonsize/2.7)
		b.frame.UpgradeIcon:SetSize(Qulight.bags.buttonsize/1.7, Qulight.bags.buttonsize/1.7)
...
function Stuffing:SlotNew(bag, slot)
	...
	if not ret.frame then
		...
		--local ilvldisplay = _G[ret.frame:CreateFontString(ilvldisplay,"OVERLAY")]
		--ilvldisplay:SetFont(Qulight["media"].font, 10, "OUTLINE")
